  ...
  speaking: {
    ...
    parts: [
      ...
      },
      {
        part: "Part 2",
        time: "3-4 mins",
        description: "Cue card/topic card monologue",
      },
      {
        part: "Part 3",
        time: "4-5 mins",
        description: "Discussion on abstract issues related to Part 2",
      },
    ],
  },
};
...
const batches = [
  ...
  },
  {
    ...
    description:
      "Comprehensive coverage with weekly practice tests and feedback",
    features: [
        ...
        {activeTab && (
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="bg-white/60 backdrop-blur-md rounded-2xl shadow-lg border border-border/40 overflow-hidden"
            >
              ...
              <div className="p-6 md:p-8">
                ...
                {activeTab === "structure" && (
                  <div className="space-y-8">
                    <p className="text-muted-foreground text-center max-w-3xl mx-auto">
                      ...
                      is globally recognized for assessing English proficiency
                      across four key skills. Available in{" "}
                      <strong className="text-foreground">Academic</strong> and
                      <strong className="text-foreground">
                        {" "}
                        General Training
                      </strong>{" "}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      >
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <div>
                            <h4 className="font-serif text-xl font-bold text-blue-700">
                              Listening
                            </h4>
                            <p className="text-sm text-blue-600">
                              {examStructure.listening.duration}
                            </p>
                          </div>
                        </div>
                        <p className="text-blue-700 font-medium mb-3">
                          {examStructure.listening.questions}
                        </p>
                        <ul className="space-y-2">
                          {examStructure.listening.sections.map(
                            (section, idx) => (
                              <li
                                key={idx}
                      ...
                      >
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <div>
                            <h4 className="font-serif text-xl font-bold text-emerald-700">
                              Reading
                            </h4>
                            <p className="text-sm text-emerald-600">
                              {examStructure.reading.duration}
                            </p>
                          </div>
                        </div>
                        <div className="space-y-2 mb-3">
                          <p className="text-sm text-emerald-600">
                            ...
                            {examStructure.reading.academic}
                          </p>
                          <p className="text-sm text-emerald-600">
                            <strong>General:</strong>{" "}
                            {examStructure.reading.general}
                          </p>
                        </div>
                        <ul className="space-y-2">
                        ...
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-amber-600">
                              {examStructure.writing.duration}
                            </p>
                          </div>
                        </div>
                        <div className="space-y-4">
                          <div className="bg-white/50 rounded-lg p-3">
                            <p className="font-medium text-amber-700">
                              Task 1 ({examStructure.writing.task1.time},{" "}
                              {examStructure.writing.task1.words})
                            </p>
                            <p className="text-sm text-amber-600 mt-1">
                              <strong>Academic:</strong>{" "}
                              {examStructure.writing.task1.academic}
                            </p>
                            <p className="text-sm text-amber-600">
                              <strong>General:</strong>{" "}
                              {examStructure.writing.task1.general}
                            </p>
                          </div>
                          <div className="bg-white/50 rounded-lg p-3">
                            <p className="font-medium text-amber-700">
                              Task 2 ({examStructure.writing.task2.time},{" "}
                              {examStructure.writing.task2.words})
                            </p>
                            <p className="text-sm text-amber-600 mt-1">
                              {examStructure.writing.task2.description}
                            </p>
                          </div>
                        </div>
                      </motion.div>
                      ...
                      >
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <div>
                            <h4 className="font-serif text-xl font-bold text-rose-700">
                              Speaking
                            </h4>
                            <p className="text-sm text-rose-600">
                              {examStructure.speaking.duration} •{" "}
                              {examStructure.speaking.format}
                            </p>
                          </div>
                        </div>
                ...
                {activeTab === "batches" && (
                  <div className="space-y-8">
                    <p className="text-muted-foreground text-center max-w-3xl mx-auto">
                      Choose the perfect plan for your IELTS preparation. All
                      courses include expert guidance, practice materials, and
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      {batches.map((batch, index) => (
                        ...
                        >
                          ...
                          <div
                            className={`bg-gradient-to-r ${batch.gradient} p-6 text-white`}
                          >
                          ...
                          <div className="p-6">
                            ...
                            <div className="bg-purple-50 rounded-lg p-4 mb-6">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {batch.dates.map((date, idx) => (
                                  <span
                                    key={idx}
                                    className="bg-white text-purple-600 text-xs px-3 py-1 rounded-full border border-purple-200"
                                  >
                                    {date}
                                  </span>
                                ))}
                            ...
                            <Button
                              className={`w-full bg-gradient-to-r ${batch.gradient} hover:opacity-90`}
                            >
                              Enroll Now
                ...
                {activeTab === "mock" && (
                  <div className="space-y-8">
                    <p className="text-muted-foreground text-center max-w-3xl mx-auto">
                      Practice with our comprehensive mock tests designed to
                      simulate the real IELTS exam experience. Get instant
                      feedback and detailed analysis of your performance.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      {mockQuestions.map((mock, index) => (
                        ...
                        >
                          <div
                            className={`w-16 h-16 ${mock.bg} rounded-full flex items-center justify-center mx-auto mb-4 border-4 border-white shadow-lg`}
                          >
                          ...
                          <p className={`${mock.color} font-medium`}>
                    ...
                    >
                      <div className="max-w-2xl mx-auto">
                        ...
                        <p className="text-white/90 mb-6">
                          Take a complete simulated IELTS exam with all 4
                          modules. Get detailed band score prediction and
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="bg-emerald-50 rounded-xl p-6 border border-emerald-200 text-center">
                        ...
                        <p className="text-muted-foreground text-sm">
                          Get accurate band score predictions based on your
                          performance
                        </p>
                      </div>
                      <div className="bg-emerald-50 rounded-xl p-6 border border-emerald-200 text-center">
                        ...
                        <p className="text-muted-foreground text-sm">
                          Receive detailed feedback from certified IELTS
                          trainers
                        </p>
                      </div>
                      <div className="bg-emerald-50 rounded-xl p-6 border border-emerald-200 text-center">
                        ...
                        <p className="text-muted-foreground text-sm">
                          Practice under real exam conditions with strict timing
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {activeTab === "videos" && (
                  <div className="space-y-8">
                    <p className="text-muted-foreground text-center max-w-3xl mx-auto">
                      Learn proven strategies and tips from our expert IELTS
                      trainers.
                    </p>
                    ...
                    >
                      ...
                      <p className="text-white/90 mb-6 max-w-xl mx-auto">
                        Get access to 100+ free IELTS preparation videos, live
                      ...
                      <Button
                        ...
                        onClick={() =>
                          window.open(
                            "https://www.youtube.com/@GlobeTrekOverseasPathway",
                            "_blank",
                          )
                        }
                      >
